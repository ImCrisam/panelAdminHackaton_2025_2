    ...
    <>
      ...
      <CTableHead color="dark">
        <CTableRow>
          ...
          <CTableHeaderCell className="text-end">Monto (COP)</CTableHeaderCell>
        </CTableRow>
      </CTableHead>
      <CTableBody>
        {pagos.length > 0 ? (
          pagos.map((pago, index) => (
            <CTableRow key={pago.id}>
              ...
              <CTableDataCell>{pago.pagador}</CTableDataCell>
              <CTableDataCell>{pago.estudiante}</CTableDataCell>
              <CTableDataCell>{pago.metodoPago}</CTableDataCell>
              <CTableDataCell>{pago.concepto}</CTableDataCell>
              <CTableDataCell>{new Date(pago.fechaPago).toLocaleDateString('es-CO')}</CTableDataCell>
